...
If you still don't see Python 3.10, you may need to install it from python.org and recreate the virtual environment using:
...
Open a browser for Spotify login
Redirect to a localhost URL
...
Asks how many tracks to sync (default: 50)
Fetches your saved Spotify songs
Gets audio features (valence, energy, tempo)
Stores in database
...
🎮 Using MoodDJ
Home Page: Click "Get Started"
Dashboard Opens: You'll see 4 sections:
Camera feed (top left)
Current mood display (top right)
Music player (middle right)
Analytics (bottom)
Click "Start Detection": Allows camera access
Your mood is detected every 2 seconds
Music automatically plays matching your mood!
